...
public class PersonControllerYamlTest extends AbstractIntegrationTest{
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/679\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/416\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/person/v1/848\""));
